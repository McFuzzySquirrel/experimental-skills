...
5. Creates or updates the map only after explicit confirmation.
6. Proposes a scoped `AGENTS.md` maintenance section and requires separate confirmation before writing it.
